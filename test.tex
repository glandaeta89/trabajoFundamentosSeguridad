...
Review, denominado “The right to privacy” \citep{warren1995} como el hito decisivo en el surgimiento del concepto de privacidad, es fundamental la creación de una figura encargada de velar por nuestra intimidad. Por estas necesidades es que nace la figura del Delegado de Protección de Datos (DPO, por sus siglas en inglés). Este profesional tiene un rol fundamentes en la gestión y protección de datos personales en las organizaciones tanto públicas como privadas, garantizando el cumplimiento de las normativas de protección de datos y promoviendo practicas que aseguren la privacidad de la información personal.
